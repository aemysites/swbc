...
## Environments
- Preview: https://main--swbc--aemysites.aem.page/
- Live: https://main--swbc--aemysites.aem.live/
- Block Library: https://main--swbc--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `swbc` directory in your favorite IDE and start coding :)
